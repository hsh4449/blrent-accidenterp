...
VEHICLE_NUMBERS = [
    ...
    '3910', '6078', '7986', '9578',
    # 2026-08-24 사용자 지시로 제외: 5080(이력도 삭제), 9577(이력은 hq 유지), 5125(당일 추가분 철회, 이력 없음)
]
...
OWNER_TRANSFERS = {
    ...
    # 본사 → 굿초이스 (2026-08-24 지시): 115하9578 스포티지 HEV, 8/20 매각/이관. 이전 내역은 hq 유지, fleet 미등록.
    '9578': [('2026-08-20', 'good')],
