...
# 사용자(황성현)가 명시적으로 "킬스위치 해제" 라고 요청한 경우에만 False 로
# 변경 + git push 가능. 절대 자동으로 풀지 마세요.
# 풀린 후에도 accident_send_settings.send_armed 게이트 + 사용자 확인이 추가로 필요합니다.
#
# 설정 이유: 사용자 지시 (2026-05-19)
#   "문자발송은 모든프로그램이 완성되고나서 내가 승인해야 그때 문자발송하고
#    그전까진 프로그램만 만들어"
# ─────────────────────────────────────────────────────────────────────────
